...
function Field({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: role=group matches W3C form field grouping guidelines
    <div
      role="group"
      data-slot="field"
  ...
  const content = useMemo(() => {
    ...
    return (
      <ul className="ml-4 flex list-disc flex-col gap-1">
        {uniqueErrors.map(
          (error, index) =>
            // biome-ignore lint/suspicious/noArrayIndexKey: error list items are static snapshots
